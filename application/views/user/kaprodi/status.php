        ...
        foreach ($wisuda as $wsd) : ?>
            <tbody>
                <tr align="center">
                    ...
                    <td>
                        <a href="<?php echo base_url('') ?>kaprodi/detail/<?= $wsd['id_pengajuan'] ?>" class="btn btn-success"><i class="fas fa-eye"> Detail</i> </a>
                    </td>
                    <td><a href="<?php echo base_url('') ?>kaprodi/ubah/<?= $wsd['id_pengajuan'] ?>" class="btn btn-warning"><i class="fas fa-user-edit"> Edit Pengajuan</i> </a>
                    </td>
                    <td> <a href="<?php echo base_url('') ?>kaprodi/hapus/<?= $wsd['id_pengajuan'] ?>" class="btn btn-danger"><i class="fas fa-trash-alt"> Hapus</i></a></td>
                </tr>
            </tbody>
        <?php endforeach ?>
    </table>
